...
describe("linesOut = MasterCardFilter.filter(linesIn)", function() {
...
describe("dateColumn = linesOut[i][0]", function() {
  
  it('should be a string and match the pattern /\d{4}-\d{2}-\d{2}/', function() {
